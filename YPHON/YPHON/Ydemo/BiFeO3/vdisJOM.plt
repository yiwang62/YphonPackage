...
set output "vdisBIFeO3JOM.eps"

set label 1 "BiFeO_3" at graph 0.65,0.94 left font "Times_Roman,32"
set label 2 "[zzz]" at graph 0.02,-0.05 left font "Symbol,20"
set label 3 "[zz0]" at graph 0.38,-0.05 left font "Symbol,20"
set label 4 "[z-z0]" at graph 0.55,-0.05 left font "Symbol,20"
set label 5 "[zz2z]" at graph 0.84,-0.05 left font "Symbol,20"
...
set xtics ( '{/Symbol G}' qunit*0.000000, '[111]' qunit*0.108165, '[110] ' qunit*0.217753, '{/Symbol G}' qunit*0.343886, '[1-10]' qunit*0.523131, '{/Symbol G}' qunit*0.700640)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p5*1.0001] [funit*-0.000000:funit*21.000000] \
'vlineJOM.dat' using (qunit*$1):(funit*$2) notitle w l lt 4, \
 'vdisJOM.out' index 0 using (qunit*p0+qunit*$1):(funit*$5) notitle w l lt -1, \
 ...
 'exp03.dat' index 0 using (qunit*p0+qunit*pp0*($1)):(eunit*$2) title "Borissenko" w p pt 6 lw 2 lt 1, \
 '' index 1 using (qunit*p2+qunit*pp2*(1-$1)):(eunit*$2) notitle w p pt 6 lw 2 lt 1, \
 '' index 2 using (qunit*p3+qunit*pp3*($1)):(eunit*$2) notitle w p pt 6 lw 2 lt 1, \
 '' index 3 using (qunit*p4+qunit*pp4*(1-$1)):(eunit*$2) notitle w p pt 6 lw 2 lt 1
